...
const CONFIG = {
  CHANNELS: {
    CONTRACT_ANNOUNCEMENT: '1514085644526293012',
    FA_ANNOUNCEMENT:       '1514085319971045577',
    SCOUTING_ANNOUNCEMENT: '1514085978573246504',
  },

  ROLES: {
    FA_ROLE:     '1516618304176001034',
    STAFF_ROLES: ['1515813193728000080', '1515813346845262045'],   // quem pode propor contratos e scouting
TEAM_ROLES: [
  '1516626245717332018',
  '1516626517948370964',
  '1516626640858386682',
...
const ALLOWED_COMMAND_CHANNEL = '1514084888402464870'; // canal onde /contract e /scouting podem ser usados
...
client.once(Events.ClientReady, async () => {
  ...
  client.user.setPresence({ activities: [{ name: 'BS26 | Brazilian Soccer 2026', type: 0 }], status: 'online' });
  loadContracts();
